...
#define BS_IOPORT_7_VAL ((const uint8 CYFAR *)0x480005DCu)
...
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x480005F8u)

/* IOPINS0_1 Address: CYREG_PRT1_DM0 Size (bytes): 8 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x48000600u)
...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000614u)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x4800061Cu)
...
uint8 CYXDATA * const CYCODE AMux__addrTable[12] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE AMux__maskTable[12] = {
	0x40u, 0x04u, 
	0x80u, 0x08u, 
	0x10u, 0x01u, 
	0x10u, 0x00u, 
